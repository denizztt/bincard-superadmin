 ...
 */
public class PaymentPointAddPageNew extends SuperadminPageBase {
    ...
    public PaymentPointAddPageNew(Stage stage, TokenDTO accessToken, TokenDTO refreshToken) {
    ...
    private VBox createBasicInfoSection() { 
        ...
        section.getChildren().add(new Label("Temel Bilgiler"));
        
        nameField = new TextField();
        nameField.setPromptText("Ödeme noktası adı");
        section.getChildren().addAll(new Label("Ödeme Noktası Adı:"), nameField);
    ...
    private VBox createLocationSection() { 
        VBox section = new VBox(10);
        section.getChildren().add(new Label("Konum Bilgileri"));
        ...
        streetField.setPromptText("Sokak/Cadde");
    ...
    private VBox createContactSection() { 
        VBox section = new VBox(10);
        section.getChildren().add(new Label("İletişim Bilgileri"));
        
        contactNumberField = new TextField();
        contactNumberField.setPromptText("İletişim numarası");
        ...
        section.getChildren().addAll(
            new Label("İletişim Numarası:"), contactNumberField,
    ...
    private VBox createWorkingHoursSection() { 
        VBox section = new VBox(10);
        section.getChildren().add(new Label("Çalışma Saatleri"));
        
        workingHoursLabel = new Label("09:00 - 17:00");
        
        startHourSlider = new Slider(0, 23, 9);
        startMinuteSlider = new Slider(0, 59, 0);
        endHourSlider = new Slider(0, 23, 17);
        endMinuteSlider = new Slider(0, 59, 0);
        
        section.getChildren().addAll(
            new Label("Çalışma Saatleri:"), workingHoursLabel,
            new Label("Başlama Saati:"), startHourSlider,
            new Label("Bitiş Saati:"), endHourSlider
        );
    ...
    private VBox createPaymentMethodsSection() { 
        VBox section = new VBox(10);
        section.getChildren().add(new Label("Ödeme Yöntemleri"));
        ...
        section.getChildren().addAll(
            cashCheckBox, creditCardCheckBox, debitCardCheckBox,
    ...
    private VBox createOtherInfoSection() { 
        VBox section = new VBox(10);
        section.getChildren().add(new Label("Diğer Bilgiler"));
        
        activeCheckBox = new CheckBox("Aktif");
        activeCheckBox.setSelected(true);
        
        section.getChildren().add(activeCheckBox);
    ...
    private HBox createButtonContainer() { 
        ...
        container.getChildren().addAll(saveButton, clearButton, cancelButton);
